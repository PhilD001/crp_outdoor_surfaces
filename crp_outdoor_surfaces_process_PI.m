...
%% STEP 1: re-organize data in folders

surface = {'Grass','FlatEven','CobbleStone','SlopeDown','SlopeUp','StairDown','StairUp'};
fl = engine('fld',fld);
...
%% STEP 2: CRP Analyses
 ...
 %fld = '/Users/patrick/Documents/MATLAB/Research/Outdoor_Gait/crp_outdoor_surfaces-main/data';
 %fld_root = '/Users/patrick/Documents/MATLAB/Research/Outdoor_Gait/crp_outdoor_surfaces-main';

fld_data_proc = [fld_root, filesep, 'processed'];
mkdir(fld_data_proc);
copyfile(fld,fld_data_proc)

surface = {'Grass','FlatEven','CobbleStone','SlopeUp','SlopeDown','StairUp','StairDown'};
...
%% STEP 3: EXTRACT TRIAL BY TRIAL EVENTS TO SPREADSHEET ====================================================
...
count = 1;
for i = 1:2
    cons{1, count} = [filesep, surface{i}];
    count= count +1;
end
...
eventval('fld_data_proc', fld_data_proc, 'dim1', cons, 'dim2', subjects, 'ch', chns, ...
